# Generated by Django 4.2.5 on 2024-03-28 16:16
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('db_train', '0002_alter_author_gender'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='author',
            name='image',
            field=models.ImageField(blank=True, help_text='Фото в профиль, можно не своё! Ну или хоть какое-то. Ладно можно без фото', null=True, upload_to='foto_profile', verbose_name='Фото профиля'),
        ),
        migrations.AlterField(
            model_name='author',
            name='last_name',
        ...
        migrations.AlterField(
            model_name='author',
            name='phone_number',
            field=models.CharField(blank=True, help_text="Введите номер телефона через '+7' без пробелов в формате +79123456789 ", max_length=12, null=True, unique=True, validators=[django.core.validators.RegexValidator(message="Телефонный номер должен быть формата: '+79123456789'.", regex='^\\+79\\d{9}$')], verbose_name='Телефон'),
        ),
        migrations.AlterField(
            model_name='author',
            name='self_esteem',
            field=models.DecimalField(blank=True, decimal_places=1, help_text="Введите уровень вашей самооценки, только честно! Градация от 0 до 5, где 0 - 'я молодец', 5 - 'я умница'", max_digits=2, null=True, verbose_name='Уровень самооценки'),
        ),
        migrations.AlterField(
            model_name='author',
            name='status_rule',
        ...
        migrations.AlterField(
            model_name='author',
            name='username',
            field=models.SlugField(help_text="Введите username, не длиннее 50 символов. Использоавать нужно английский алфавит, разделять фраы нужно символом '-' ", unique=True, verbose_name='Имя аккаунта'),
        ),
    ]
